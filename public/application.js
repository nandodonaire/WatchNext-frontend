...
var config = {
  apiOrigins: {
    production: 'https://stark-dawn-66770.herokuapp.com',
...
var appEvents = __webpack_require__(16);
...
var signInSuccess = function signInSuccess(data) {
  ...
  // $('#modalLabel').css('color', 'green')
  $('#messages').empty();
  var welcomeMessageHTML = '<p>Welcome ' + data.user.email + '! You can add entertainments to your queue by clicking on the Add To Queue button. You can then see all of the entertainments in your queue by clicking on Show Queue.</p>';
...
var appApi = __webpack_require__(17);
var appUi = __webpack_require__(18);
var getFormFields = __webpack_require__(6);
...
var onCreate = function onCreate(event) {
  ...
  event.preventDefault();
  // console.log(data)
  appApi.createEntertainment(data).then(appUi.createEntertainmentSuccess).catch(appUi.createEntertainmentFailure);
...
var onGetAll = function onGetAll(event) {
  ...
  event.preventDefault();
  // console.log(data)
  appApi.getAll(data).then(appUi.getAllSuccess).catch(appUi.getAllFailure);
};

var onGetEntertainment = function onGetEntertainment(event) {
  var data = getFormFields(this);
  event.preventDefault();
  // console.log(data)
  appApi.getOneEntertainment(data).then(appUi.getOneEntertainmentSuccess).catch(appUi.getOneEntertainmentFailure);
  $('#entertainment-search').find('input:text, select, textarea').val('');
};

var onUpdateEntertainment = function onUpdateEntertainment(event) {
  var data = getFormFields(this);
  event.preventDefault();
  // console.log(data)
  appApi.updateEntertainment(data).then(appUi.updateEntertainmentSuccess).catch(appUi.updateEntertainmentFailure);
  $('#updateEntertainment').find('input:text, select, textarea').val('');
};

var onEntertainmentDelete = function onEntertainmentDelete(event) {
  var data = getFormFields(this);
  event.preventDefault();
  // console.log(data)
  appApi.deleteEntertainment(data).then(appUi.deleteEntertainmentSuccess).catch(appUi.deleteEntertainmentFailure);
...
var createEntertainment = function createEntertainment(data) {
  return $.ajax({
...
var getOneEntertainment = function getOneEntertainment(data) {
  return $.ajax({
...
var updateEntertainment = function updateEntertainment(data) {
  return $.ajax({
    url: config.apiOrigin + '/entertainments/' + data.entertainment.id,
    method: 'PATCH',
    headers: {
...
var deleteEntertainment = function deleteEntertainment(data) {
  return $.ajax({
    url: config.apiOrigin + '/entertainments/' + data.entertainment.id,
    method: 'DELETE',
    headers: {
...
module.exports = {
  createEntertainment: createEntertainment,
  getAll: getAll,
  getOneEntertainment: getOneEntertainment,
  updateEntertainment: updateEntertainment,
  deleteEntertainment: deleteEntertainment
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var createEntertainmentFailure = function createEntertainmentFailure(data) {
  // console.log(error)
  $('#messages').empty();
...
var getAllSuccess = function getAllSuccess(data) {
  // console.log(data)
  $('#content').empty();
  $('#messages').empty();
  var showQueueHTML = showEntertainmentsQueueTemplate({ entertainments: data.entertainments });
...
var getAllFailure = function getAllFailure(data) {
  // console.log(error)
  $('#content').empty();
  $('#messages').empty();
...
var getOneEntertainmentSuccess = function getOneEntertainmentSuccess(data) {
  // console.log(data)
  $('#content').empty();
  $('#messages').empty();
  var oneEntertainmentHTML = '<ul>\n    <li><h2>Title: ' + data.entertainment.title + '</h2></li>\n    <li>ID: ' + data.entertainment.id + ' </li>\n    <li>Type: ' + data.entertainment.ent_type + '</li>\n    <li>Genre: ' + data.entertainment.genre + '</li>\n    <li>Synopsis: ' + data.entertainment.synopsis + '</li>\n    <li>Where to Watch: ' + data.entertainment.where_to_watch + '</li>\n    </ul>';
  $('#content').append(oneEntertainmentHTML);
  $('#messages').append('Here is the entertainment that you requested:');
};

var getOneEntertainmentFailure = function getOneEntertainmentFailure(data) {
  // console.log(error)
  $('#content').empty();
  $('#messages').empty();
...
var updateEntertainmentSuccess = function updateEntertainmentSuccess(data) {
  $('#content').empty();
  $('#messages').empty();
  // $('#updateModalLabel').text('Updated entertainment')
  // $('#updateModalLabel').css('color', 'green')
  var updatedEntertainmentHTML = '<ul>\n    <li><h2>Title: ' + data.entertainment.title + '</h2></li>\n    <li>ID: ' + data.entertainment.id + ' </li>\n    <li>Type: ' + data.entertainment.ent_type + '</li>\n    <li>Genre: ' + data.entertainment.genre + '</li>\n    <li>Synopsis: ' + data.entertainment.synopsis + '</li>\n    <li>Where to Watch: ' + data.entertainment.where_to_watch + '</li>\n    </ul>';
...
var updateEntertainmentFailure = function updateEntertainmentFailure(data) {
  // console.log(error)
  $('#content').empty();
  $('#messages').empty();
...
var deleteEntertainmentSuccess = function deleteEntertainmentSuccess(data) {
  $('#content').empty();
  $('#messages').empty();
  $('#messages').text('Entertainment has been deleted! Please click on Show Queue to see your updated queue.');
};

var deleteEntertainmentFailure = function deleteEntertainmentFailure(data) {
  // console.log(error)
  $('#content').empty();
  $('#messages').empty();
...
module.exports = {
  createEntertainmentSuccess: createEntertainmentSuccess,
  createEntertainmentFailure: createEntertainmentFailure,
  getAllSuccess: getAllSuccess,
  getAllFailure: getAllFailure,
  getOneEntertainmentSuccess: getOneEntertainmentSuccess,
  getOneEntertainmentFailure: getOneEntertainmentFailure,
  updateEntertainmentSuccess: updateEntertainmentSuccess,
  updateEntertainmentFailure: updateEntertainmentFailure,
  deleteEntertainmentSuccess: deleteEntertainmentSuccess,
  deleteEntertainmentFailure: deleteEntertainmentFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n <ul data-id=\""
    ...
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "</li>\n     <li>"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.ent_type : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "</li>\n     <li>"
    ...
    + "</li>\n     <li>"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.synopsis : stack1),{"name":"if","hash":{},"fn":container.program(10, data, 0, blockParams),"inverse":container.program(12, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "</li>\n     <li>"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.where_to_watch : stack1),{"name":"if","hash":{},"fn":container.program(14, data, 0, blockParams),"inverse":container.program(16, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "</li>\n </div>\n <!-- <li><button class=\"removeButton\" class=\"btn btn-default\">Remove from Queue</button></li> -->\n</ul>\n\n";
},"2":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "\n       Type: "
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.ent_type : stack1), depth0))
    + "\n";
},"4":function(container,depth0,helpers,partials,data) {
    return "       Type: No type provided.\n     ";
  ...
  return "\n       Genre: "
    ...
    return "       Genre: No genre provided.\n     ";
},"10":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "\n       Synopsis: "
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.synopsis : stack1), depth0))
    + "\n";
},"12":function(container,depth0,helpers,partials,data) {
    return "       Synopsis: No synopsis provided.\n     ";
},"14":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "\n       Where to watch: "
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.where_to_watch : stack1), depth0))
    + "\n";
},"16":function(container,depth0,helpers,partials,data) {
    return "       Where to watch: No info provided.\n     ";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.entertainments : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
$('.logged-in').addClass('hide');
$('.app-api-functionality').addClass('hide');
$('#messages').append(" Having trouble remembering all of the movies and TV shows you'd like to watch and where you can watch them? You can keep track of all of them here! Please click on Account and sign in to view and add to your queue.");
$('#content').addClass('hide');
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
